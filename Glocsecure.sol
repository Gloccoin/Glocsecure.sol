...
contract GlocSecure is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xBF3c0520e0Ca5DFBd55fa21DdB4d8C7b20e849b6;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 4500000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Gloc Secure";
    string private _symbol = "GLOCS";
    ...
    uint256 public _maxTxAmount = 4500000000000000 * 10**18;
